...
weights = {
    ...
    EnumeratedType.declare("DrinkColor", ["green", "yellow", "red"]): Fraction(1),
...
dk &=  (PropositionalVariable("kiwi") >> EnumeratedType("DrinkColor")["green"])\
     & ((PropositionalVariable("banana") >> EnumeratedType("DrinkColor")["yellow"]))
