...
class discreteL1DistanceFunction(distanceFunctionOnNumericalTuple.distanceFunctionOnNumericalTuple):
    def __init__(self, *w, epsilon : Fraction):
        self._distance = l1DistanceFunction.l1DistanceFunction(*w)
