...
weights = {
    ...
    PropositionalVariable("granulatedSugar", fmName="granulatedSugar"): Fraction(1),
    # Presence of ice cubes, a boolean variable with a heavy weight
    PropositionalVariable("iceCube", fmName="iceCube"): Fraction(1),
    ...
    PropositionalVariable("vanillaSugar", fmName="vanillaSugar"): Fraction(1),
